...
export default function ChooseUs() {
  return (
    <>
        <section className="bg-vs-secondary space-extra-bottom">
        <div className="container">
            <div className="row text-center text-lg-start">
                ...
                <div className="col-lg-7 col-xl-6">
                    <div className="title-area">
                        <p className="sec-text text-white">We are constantly expanding the range of services offered, taking care of children of all ages. Our goal is to carefully educate and develop children in a fun way. We strive to turn the learning process into a bright.</p>
                    </div>
                </div>
            </div>
    ...
    <section className=" space-top bg-smoke">
        <div className="container">
